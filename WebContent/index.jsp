				...
				<tr>
					<td width="190" height="120" class="active" align="center"><table
							...
							<tr>
								...
								Времето в София е:<br> <%=WeatherServlet.getForecast("София")%></td>
						</table></td>
					...
					%>
					<td width="596" rowspan="4" align="center"><a
						href="destinations.jsp"><img src="images/bgmap1.png"
							width="590px" height="400px" /></a></td>
					<%
						}
					%>
				</tr>
